...
export default function ConnectionScreen() {
  ...
  return (
    <div className={cn(
      "min-h-screen bg-slate-900 flex items-center justify-center p-6 relative overflow-hidden",
      isScanning ? "bg-transparent" : ""
    )}>
      {isScanning && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-between py-12 bg-black/30">
          <div className="text-white font-bold text-xl drop-shadow-md">Scan QR Code</div>
          ...
          <button
            onClick={stopScan}
            className="bg-red-500/80 text-white px-8 py-3 rounded-full font-bold backdrop-blur-md"
          >
            Cancel Scan
          </button>
        </div>
