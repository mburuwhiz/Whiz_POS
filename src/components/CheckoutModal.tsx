...
export default function CheckoutModal() {
  ...
  const handleComplete = () => {
    ...
    // Pass the selected payment method to the store.
    // The completeTransaction action in the store is responsible for closing the modal and clearing the cart.
    // We don't need to reset the state here, as the component will re-initialize next time it opens.
